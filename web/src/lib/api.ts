...
export const api = {
  ...
  getNotifications: () => request<{ items: NotificationItem[] }>(API_ROUTES.notifications),
  clearNotifications: () => request<{ success: boolean }>(API_ROUTES.notificationsClear, { method: 'POST' }),
